...
class Miscellaneous(commands.Cog, description="Other miscellaneous commands."):
    ...
    @commands.command(
        ...
        brief="View Sonicbot's information",
    ...
    async def info(self, ctx):
        ...
        embed.set_footer(
            text="Copyright (C) 2021 Sonicbot."
        )
    ...
    async def suggest(self, ctx, *, suggestion):
        ...
        await ctx.send(
            "✅ Your suggestion has been submitted to Sonicbot's server! A link to the server can be found in my About Me, or the `info` command.",
        )
    ...
    # Changelog
    @commands.command(help="See what's new in the latest version of Sonicbot")
    ...
    @cog_ext.cog_slash(
        name="changelog", description="See what's new in the latest version of Sonicbot"
    )
